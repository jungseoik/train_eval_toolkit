# e.g.
## GPUS=2 PER_DEVICE_BATCH_SIZE=2 sh scripts/shell/internvl3.0/hyundai_2_20.sh
# choose samller PER_DEVICE_BATCH_SIZE to reduce GPU Memory
# h100
# GPUS=4 PER_DEVICE_BATCH_SIZE=2 BATCH_SIZE=256 sh scripts/shell/internvl3.0/hyundai_2_20.sh
# GPUS=4 PER_DEVICE_BATCH_SIZE=2 sh scripts/shell/internvl3.0/hyundai_2_20.sh
...
torchrun \
  ...
  --meta_path "scripts/shell/data/hyundai_2_15.json" \
...
MERGE_DIR="InternVL3-2B_hyundai_2_20"
