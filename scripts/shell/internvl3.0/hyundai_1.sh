# e.g.
## GPUS=2 PER_DEVICE_BATCH_SIZE=2 sh scripts/shell/internvl3.0/hyundai_1.sh
# choose samller PER_DEVICE_BATCH_SIZE to reduce GPU Memory
# h100
# GPUS=4 PER_DEVICE_BATCH_SIZE=2 BATCH_SIZE=256 sh scripts/shell/internvl3.0/hyundai_1.sh
# GPUS=4 PER_DEVICE_BATCH_SIZE=2 sh scripts/shell/internvl3.0/hyundai_1.sh
...
torchrun \
  ...
  --meta_path "scripts/shell/data/hyundai.json" \
...
MERGE_DIR="InternVL3-2B_hyundai_15"
