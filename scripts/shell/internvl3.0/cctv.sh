# e.g.
## GPUS=2 PER_DEVICE_BATCH_SIZE=2 sh scripts/shell/internvl3.0/cctv.sh
# choose samller PER_DEVICE_BATCH_SIZE to reduce GPU Memory
# h100
# GPUS=4 PER_DEVICE_BATCH_SIZE=2 BATCH_SIZE=256 sh scripts/shell/internvl3.0/cctv.sh
set -x
...
torchrun \
  ...
  --meta_path "scripts/shell/data/cctv.json" \
