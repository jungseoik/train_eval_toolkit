...
PYTHONPATH="$(pwd)" python src/evaluation/evaluate_image_classfication.py \
    ...
    --image-root data \
    --out-dir results/eval_result_image/gangnam/InternVL3-2B_gangnam_rwf2000_gj_cctv_scvdALL_NOweapon_no_split \
    --batch-size 20 \
    --multi-gpu
...
PYTHONPATH="$(pwd)" python src/evaluation/evaluate_image_classfication.py \
    ...
    --annotation data/instruction/evaluation/test_gangnam_yeoksam2_v2_image_falldown.jsonl \
    --image-root data \
    --out-dir results/eval_result_image/gangnam/InternVL3-2B_gangnam_yeoksam_v2_gaepo4_1v2_samsung_rwf2000 \
    --batch-size 20 \
    --multi-gpu
