...
from src.training.internvl.model.internlm2.modeling_internlm2 import InternLM2ForCausalLM
from src.training.internvl.model.internvl_chat import (InternVisionConfig,
                                          InternVisionModel,
                                          InternVLChatConfig,
                                          InternVLChatModel)
from src.training.internvl.patch import (concat_pad_data_collator,
...
from src.training.internvl.train.constants import (BOX_END_TOKEN, BOX_START_TOKEN,
                                      IMG_CONTEXT_TOKEN, IMG_END_TOKEN,
                                      IMG_START_TOKEN, QUAD_END_TOKEN,
                                      QUAD_START_TOKEN, REF_END_TOKEN,
                                      REF_START_TOKEN)
from src.training.internvl.train.dataset import (ConcatDataset, TCSLoader,
                                    ...
                                    preprocess_phi3)
from src.training.internvl.train.dataset_packed import PackedDataset, packed_collate_fn
...
def main():
    ...
    if model_args.use_liger:
        from src.training.internvl.patch import apply_liger_kernel_to_internvit
